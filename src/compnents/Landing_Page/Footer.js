...
import styles from "../Landing_Page/css/footer.module.css"
    ...
    <>
      <div className={styles.footer}>
        <div className={`${styles.footerSection} ${styles.links}`}>
          ...
          <a href='/product-list' className={styles.footerLink}>Products</a>
          <a href='/plants' className={styles.footerLink}>Plants</a>
